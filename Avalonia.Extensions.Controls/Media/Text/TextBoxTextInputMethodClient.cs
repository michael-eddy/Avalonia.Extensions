...
namespace Avalonia.Extensions.Media.Text
{
    internal sealed class TextBoxTextInputMethodClient : ITextInputMethodClient
    {
        ...
        public Rect CursorRectangle
        {
            get
            {
                ...
                if (transform == null)
                    return default;
                var rect = _presenter.InvokeMethod<Rect>("GetCursorRectangle");
