...
using Avalonia.Data;
using Avalonia.Extensions.Media.Text;
...
{
    [PseudoClasses(":empty")]
    public class EditTextView : TemplatedControl, UndoRedoHelper<EditTextView.UndoRedoState>.IUndoRedoHost
    {
        ...
        public static readonly StyledProperty<bool> AcceptsReturnProperty =
            AvaloniaProperty.Register<EditTextView, bool>(nameof(AcceptsReturn));
        public static readonly StyledProperty<bool> AcceptsTabProperty =
            AvaloniaProperty.Register<EditTextView, bool>(nameof(AcceptsTab));
        ...
        public static readonly StyledProperty<bool> IsReadOnlyProperty =
            AvaloniaProperty.Register<EditTextView, bool>(nameof(IsReadOnly));
        public static readonly StyledProperty<char> PasswordCharProperty =
            AvaloniaProperty.Register<EditTextView, char>(nameof(PasswordChar));
        public static readonly StyledProperty<IBrush> SelectionBrushProperty =
            AvaloniaProperty.Register<EditTextView, IBrush>(nameof(SelectionBrushProperty));
        public static readonly StyledProperty<IBrush> SelectionForegroundBrushProperty =
            AvaloniaProperty.Register<EditTextView, IBrush>(nameof(SelectionForegroundBrushProperty));
        public static readonly StyledProperty<IBrush> CaretBrushProperty =
            AvaloniaProperty.Register<EditTextView, IBrush>(nameof(CaretBrushProperty));
        ...
        public static readonly StyledProperty<int> MaxLengthProperty =
            AvaloniaProperty.Register<EditTextView, int>(nameof(MaxLength), defaultValue: 0);
        ...
        public static readonly StyledProperty<TextAlignment> TextAlignmentProperty =
            TextBlock.TextAlignmentProperty.AddOwner<EditTextView>();
        ...
        public static readonly DirectProperty<EditTextView, string> NewLineProperty =
            AvaloniaProperty.RegisterDirect<EditTextView, string>(nameof(NewLine),
        ...
        static EditTextView()
        {
            ...
            TextInputMethodClientRequestedEvent.AddClassHandler<EditTextView>((tb, e) =>
            {
        ...
        {
            _presenter = e.NameScope.Get<TextView>("PART_TextPresenter");
            _imClient.InvokeMethod("SetPresenter", new object[] { _presenter, this });
            if (IsFocused)
        ...
        protected override void OnPointerMoved(PointerEventArgs e)
        {
            ...
            {
                var point = e.GetPosition(_presenter);
                point = new Point(MathUtilities.Clamp(point.X, 0, Math.Max(_presenter.Bounds.Width - 1, 0)),
        ...
        private void SnapshotUndoRedo(bool ignoreChangeCount = true)
        {
            if (IsUndoEnabled)
            {
                if (ignoreChangeCount || !_hasDoneSnapshotOnce || (!ignoreChangeCount &&
