...
namespace Avalonia.Extensions.Utils
{
    internal sealed class StringUtils
    {
        ...
        public static bool IsStartOfWord(string text, int index)
        {
            ...
            {
                GeneralCategory.LowercaseLetter or GeneralCategory.TitlecaseLetter or GeneralCategory.UppercaseLetter or GeneralCategory.DecimalNumber
                or GeneralCategory.LetterNumber or GeneralCategory.OtherNumber or GeneralCategory.DashPunctuation or GeneralCategory.InitialPunctuation
                or GeneralCategory.OpenPunctuation or GeneralCategory.CurrencySymbol or GeneralCategory.MathSymbol => true,
                _ => false,
            };
        }
